export default class Task {
    ...
    toHTML(){
        ...
        let delButtonText = `<button id = "delButton" class = "btn btn-default task-button" name = ${this.id}>Delete</button>`;
        ...
        let editButtonText =   `<button id = "editButton" class = "btn btn-default task-button" name = ${this.id}>Edit</button>`;

        return `<tr><td>${this.id}</td><td>${text}</td><td>${radioText}</td><td>${editButtonText}</td><td>${delButtonText}</td></tr>`;
    }
}